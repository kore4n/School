...
int main(int argc, char* argv[])
{
	...
	float screenW = 1400;
	float screenH = 900;
	window = glfwCreateWindow(screenW, screenH, "Problem_Set_7_Exercise_3", NULL, NULL);
	if (window == NULL) {
	...
	std::string FragmentShaderCode = "\
		...
		void main() {\n\
			//SHADER CODE\n\
			color = texture(tex1, fragmentTextureCoordinates) * blend1 + texture(tex2, fragmentTextureCoordinates) * blend2;\n\
		}\n";
