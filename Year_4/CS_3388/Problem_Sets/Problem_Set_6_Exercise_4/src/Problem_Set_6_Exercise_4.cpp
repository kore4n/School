...
// Added by me
static const GLfloat vertex_color_buffer_data_exercise_4[] = {
	// vertex 1
	0.0f, 0.0f, 0.0f,
	// color of vertex 1
	1.0f, 0.0f, 0.0f,
...
static const unsigned int indices_exercise_4[] = {
	0, 1, 2
};
...
int main(int argc, char* argv[])
{
	...
	do {
		...
		glBufferData(GL_ARRAY_BUFFER, sizeof(GL_FLOAT) * 18, vertex_color_buffer_data_exercise_4, GL_STATIC_DRAW);

		glGenBuffers(1, &indexBufferID);
		glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, indexBufferID);
		glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(unsigned int) * 3, indices_exercise_4, GL_STATIC_DRAW);
